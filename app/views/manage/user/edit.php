...
<body>
    ...
    <main class="user has-form">
        <h4><?=$locals['title']?></h4>
        <form action="manage/user/<?= $locals['data']['id'] ?>" method="post">
        <label for="username">Username</label>
        <input type="text" name="username" id="username" value="<?= $locals['data']['username'] ?>" required>
